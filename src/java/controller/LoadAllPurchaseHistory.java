 ...
 * @author Rushma
 */
@WebServlet(name = "LoadAllPurchaseHistory", urlPatterns = {"/LoadAllPurchaseHistory"})
public class LoadAllPurchaseHistory extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (c.list().isEmpty()) {
            responseJsonObject.addProperty("message",
                    "Users have not purchased anything yet");
        } else {
