...
async function searchProduct(firstResult) {
    ...
    const price_range_start = document.getElementById("price_start").value; //left
    const price_range_end = document.getElementById("price_end").value//right
...
function updateProductView(json) {
    ...
    json.productList.forEach(product => {
        ...
        st_product_clone.querySelector("#st-product-img-1").src = "product-images//" + product.id + "//image1.jpg";
